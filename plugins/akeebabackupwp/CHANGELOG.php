...
# [LOW] Fixed backup archive variable names PLATFORM_VERSION and PLATFORM_NAME
...
Akeeba Backup 7.7.0
================================================================================
+ New endpoint for the Akeeba Backup JSON API using WordPress' wp-admin/admin-ajax.php file
+ New legacy frontend backup URL using WordPress' wp-admin/admin-ajax.php file
+ New system configuration option “Place under Tools” to change where the Akeeba Backup menu item appears
...
# [LOW] In some unusal WordPress configurations, Akeeba Backup was not able to read database information during automatic backups

Akeeba Backup 7.6.10
================================================================================
...
Akeeba Backup 7.6.1.1
================================================================================
# [HIGH] Akeeba Backup thinks the WP_DEBUG constant is always true

Akeeba Backup 7.6.1
================================================================================
+ Allow enabling browser downloads of backup archives
...
- Removed the ability to download backup archives through Akeeba Backup as many third party WordPress plugins corrupt the download.
